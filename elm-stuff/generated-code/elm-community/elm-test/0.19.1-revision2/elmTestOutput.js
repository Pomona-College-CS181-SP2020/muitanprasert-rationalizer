...
var $author$project$ParserTest$bad_number_1 = A2(
	...
	function (_v0) {
		var output = {q: $elm$core$Maybe$Nothing, rest: '2.5.24  cups water', unit: $elm$core$Maybe$Nothing};
...
var $author$project$ParserTest$no_number = A2(
	...
	'no number',
	function (_v0) {
		var output = {q: $elm$core$Maybe$Nothing, rest: 'some salt', unit: $elm$core$Maybe$Nothing};
		var input = 'some salt';
		return A2(
			$elm_explorations$test$Expect$equal,
			$author$project$Parsing$asIngredient(input),
...
var $author$project$ParserTest$no_trailing = A2(
	...
	function (_v0) {
		var output = {
			q: $elm$core$Maybe$Just(10.2),
			rest: '',
			unit: $elm$core$Maybe$Just('litres')
		};
		var input = '10.2 litres';
		return A2(
			$elm_explorations$test$Expect$equal,
			$author$project$Parsing$asIngredient(input),
			output);
...
var $author$project$ParserTest$numWord_3 = A2(
	...
	function (_v0) {
		...
		var input = 'a hundred and twenty two';
		return A2(
			$elm_explorations$test$Expect$equal,
			A2($elm$parser$Parser$run, $author$project$Parsing$numWord, input),
			output);
...
var $author$project$ParserTest$word = A2(
	...
	function (_v0) {
		...
		var input = ' two and a half  cups  whole milk';
		return A2(
			$elm_explorations$test$Expect$equal,
			$author$project$Parsing$asIngredient(input),
			output);
