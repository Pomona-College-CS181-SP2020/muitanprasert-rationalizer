module Test.Generated.Main3969376947 exposing (main)
...
main =
    ...
    HelperTest.twoDecimal_] ]
        |> Test.concat
        |> Test.Runner.Node.run { runs = Nothing, report = (ConsoleReport UseColor), seed = 343138555298188, processes = 4, paths = ["C:\\Users\\t_abc\\OneDrive - Pomona College\\muitanprasert-rationalizer\\tests\\HelperTest.elm","C:\\Users\\t_abc\\OneDrive - Pomona College\\muitanprasert-rationalizer\\tests\\ParserTest.elm"]}