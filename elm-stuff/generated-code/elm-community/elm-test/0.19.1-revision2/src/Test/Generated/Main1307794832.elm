module Test.Generated.Main1307794832 exposing (main)
...
main =
    ...
    HelperTest.twoDecimal_] ]
        |> Test.concat
        |> Test.Runner.Node.run { runs = Nothing, report = (ConsoleReport UseColor), seed = 371378651273058, processes = 4, paths = ["C:\\Users\\t_abc\\OneDrive - Pomona College\\muitanprasert-rationalizer\\tests\\HelperTest.elm","C:\\Users\\t_abc\\OneDrive - Pomona College\\muitanprasert-rationalizer\\tests\\ParserTest.elm"]}