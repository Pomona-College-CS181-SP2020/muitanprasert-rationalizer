...
var $author$project$HomePage$config = {
	beforeUpdate: F3(
...
var $annaghi$dnd_list$Internal$Common$Utils$pageX = A2($elm$json$Json$Decode$field, 'pageX', $elm$json$Json$Decode$float);
var $annaghi$dnd_list$Internal$Common$Utils$pageY = A2($elm$json$Json$Decode$field, 'pageY', $elm$json$Json$Decode$float);
var $annaghi$dnd_list$Internal$Common$Utils$decodeCoordinates = A3($elm$json$Json$Decode$map2, $annaghi$dnd_list$Internal$Common$Utils$Position, $annaghi$dnd_list$Internal$Common$Utils$pageX, $annaghi$dnd_list$Internal$Common$Utils$pageY);
...
var $author$project$HomePage$illegalInput = function (ls) {
	var quan = A3(
		$elm$core$List$foldr,
		F2(
			function (x, xs) {
	...
	var ingr = A3(
		...
		F2(
			function (x, xs) {
				return $elm$core$String$isEmpty(x.rest) || xs;
			}),
		false,
		ls);
	var _v0 = _Utils_Tuple2(ingr, quan);
	if (_v0.a) {
		if (!_v0.b) {
			return 'Your last batch has underspecified items(s).';
		} else {
			return 'Your last batch has illegal input(s).';
		}
	} else {
		if (_v0.b) {
			return 'Your last batch contains unsupported quantity.';
		} else {
			return '';
		}
	}
...
var $author$project$Parsing$ones = _List_fromArray(
	[
		...
		_Utils_Tuple2('one', 1),
		_Utils_Tuple2('two', 2),
		_Utils_Tuple2('three', 3),
		_Utils_Tuple2('four', 4),
		_Utils_Tuple2('five', 5),
		_Utils_Tuple2('six', 6),
		_Utils_Tuple2('seven', 7),
		_Utils_Tuple2('eight', 8),
		_Utils_Tuple2('nine', 9),
		_Utils_Tuple2('ten', 10),
		_Utils_Tuple2('eleven', 11),
		_Utils_Tuple2('twelve', 12),
		_Utils_Tuple2('thirteen', 13),
		_Utils_Tuple2('fourteen', 14),
		_Utils_Tuple2('fifteen', 15),
		_Utils_Tuple2('sixteen', 16),
		_Utils_Tuple2('seventeen', 17),
		_Utils_Tuple2('eighteen', 18),
		_Utils_Tuple2('nineteen', 19)
	]);
...
var $joshforisha$elm_inflect$Inflect$pascalize = A2(
	...
	A2(
		...
		$elm$core$String$join('')));
var $author$project$Parsing$tens = _List_fromArray(
	[
		_Utils_Tuple2('ten', 10),
		_Utils_Tuple2('twenty', 20),
		_Utils_Tuple2('thirty', 30),
		_Utils_Tuple2('forty', 40),
		_Utils_Tuple2('fifty', 50),
		_Utils_Tuple2('sixty', 60),
		_Utils_Tuple2('seventy', 70),
		_Utils_Tuple2('eighty', 80),
		_Utils_Tuple2('ninety', 90)
	]);
var $author$project$Parsing$allNums = A2(
	...
	function (_v0) {
		...
		return _List_fromArray(
			[
				...
				$elm$parser$Parser$keyword(word)),
				A2(
				$elm$parser$Parser$map,
				function (_v2) {
					return num;
				...
				$elm$parser$Parser$keyword(
					$joshforisha$elm_inflect$Inflect$pascalize(word)))
			]);
	},
	_Utils_ap(
			...
			[
				...
				function (_v0) {
					return $elm$parser$Parser$Done(
						$elm$core$List$reverse(revNums));
				},
				$elm$parser$Parser$succeed(_Utils_Tuple0))
			]));
};
var $author$project$Parsing$numWord = function () {
	var ls = A2($elm$parser$Parser$loop, _List_Nil, $author$project$Parsing$numWordHelp);
	return A2($elm$parser$Parser$map, $author$project$Parsing$calculate, ls);
}();
			...
			A2(
				...
				A2(
					...
					A2(
						...
						$elm$parser$Parser$symbol(' ')),
					$elm$parser$Parser$spaces))),
			$author$project$Parsing$numWord,
...
var $author$project$HomePage$Scale = function (a) {
	return {$: 'Scale', a: a};
};
var $author$project$HomePage$Submit = {$: 'Submit'};
var $author$project$HomePage$UpdateContent = function (a) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('wrap-contact100')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('contact100-form validate-form')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('contact100-form-title')
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('wrap-input100 validate-input')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('label-input100'),
												$elm$html$Html$Attributes$for('recipe')
											]),
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('input100'),
												$elm$html$Html$Attributes$id('message'),
												$elm$html$Html$Attributes$name('recipe'),
												$elm$html$Html$Attributes$placeholder('Enter to add a list of ingredients (1 ingredient per line)'),
												$elm$html$Html$Attributes$value(model.temp),
												$elm$html$Html$Events$onInput($author$project$HomePage$UpdateContent)
											]),
										_List_Nil),
										A2(
										$elm$html$Html$span,
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('focus-input100')
											]),
										_List_Nil)
									])),
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('container-contact100-form-btn')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('contact100-form-btn'),
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text(model.warningText)
											]))
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('slidecontainer')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												A2($elm$html$Html$Attributes$attribute, 'style', 'width: 100%; display: block;font-family: Montserrat-SemiBold;font-size: 20px;color: #333333;line-height: 1.2;text-align: center;margin-bottom: 1em;')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('How many servings?')
											])),
										A2(
										$elm$html$Html$input,
										_List_fromArray(
										...
										_List_fromArray(
											[
												A2($elm$html$Html$Attributes$attribute, 'style', 'text-align: center; margin-top: 0.5em;')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('contact100-more flex-col-c-m'),
								A2($elm$html$Html$Attributes$attribute, 'style', 'background-image: url(\'images/bg-02.jpg\');')
							]),
						_List_fromArray(
							[
								A2(
